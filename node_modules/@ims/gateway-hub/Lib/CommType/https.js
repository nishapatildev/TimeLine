...
module.exports = function talkToServer(transXpedia) {
	return new Promise((resolved, rejected) => {
		...
		var client = https.request({
			...
			path     				: url.pathname,
			host     				: url.host,
			ca       				: transXpedia.clientData.gatewayCaCertificate || null,
			key						: (transXpedia.clientData.key == undefined)? null : transXpedia.clientData.key,
			cert					: (transXpedia.clientData.cert == undefined)? null : transXpedia.clientData.cert,
